...
Those scripts do not install every repository in the ecosystem. After the binaries land, `stipe init` configures
supported hosts and editor integrations.
...
These projects are part of Basidiocarp, but they are not installed by the bootstrap scripts as standalone local-user
binaries:
...
- [How the Projects Connect](../architecture/integration.md)
