...
HANDOFF=".handoffs/archive/cortina/rust-tooling-adoption.md"
...
check_grep "cargo nextest run" "cortina/README.md"
check_grep "whole-command timing" "cortina/README.md"
