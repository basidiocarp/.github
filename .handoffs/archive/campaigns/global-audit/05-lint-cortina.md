...
- **Goal:** Validate cortina's code quality metrics and report any issues
...
- **Next steps:**
  ...
  5x. O1 (stdin cap): verify stdin read has a size limit (not unbounded read_to_string)
...
- [x] O1 fix verified (stdin cap): yes/no
