...
run_check "no known broken foundation links" sh -c "! rg -n '/Users/williamnewton/' docs/foundations && ! (rg -n 'stipe/CLAUDE\\.md' docs/foundations | grep -v '\\]\\|https://')"
...
run_check "troubleshooting shell pipes escaped in table commands" sh -c "! rg -n '\\|[^\\x60]*\\|\\| true' docs/operate/troubleshooting.md"
