...
**Checklist:**
- [ ] Migration adds `agent_id` column
- [ ] CLI and MCP accept agent_id parameter
- [ ] Search can filter by agent
- [ ] Existing memories without agent_id still work
...
**Checklist:**
- [ ] Cortina queries canopy for active agent identity
- [ ] Agent ID is passed to hyphae writes when available
- [ ] Missing canopy is handled gracefully (no error, no agent_id)
