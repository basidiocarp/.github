...
**Checklist:**
- [ ] `detect-spec-drift` skill validates and builds
- [ ] Skill reads canopy council proposal for active task
- [ ] Skill checks recent file changes against proposal scope
- [ ] Structured output with DRIFT DETECTED / NO DRIFT label
...
**Checklist:**
- [ ] `detect-context-drift` skill validates
- [ ] Skill checks recent tool call file patterns vs task scope
- [ ] Structured output with drift assessment
...
**Checklist:**
- [ ] `drift_signals` field in canopy snapshot output
- [ ] `schema_version: "1.0"` preserved
- [ ] Correction rate computed from cortina evidence refs
- [ ] Evidence gap computed from last evidence timestamp
