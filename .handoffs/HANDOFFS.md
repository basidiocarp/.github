...
| ~~A43~~ | ~~[Hymenium: Dispatch Command Trust Boundary](hymenium/dispatch-command-trust-boundary.md)~~ | Medium | Done 2026-04-28 — resolve_canopy_binary + env_clear + cancellation-channel kill timeout; capability_client absolute-path enforcement; 5 integration tests; verify 5/5; hymenium d06afe5 |
...
| ~~A23~~ | ~~[Volva: Backend And Credential Runtime Safety](volva/backend-and-credential-runtime-safety.md)~~ | Medium | Done 2026-04-28 — 60s backend timeout + kill/wait; env_clear on hook adapters; trusted field + cortina implicit trust + untrusted warn; check_credential_permissions (0o077 bail); corrupt checkpoint → Err + tracing::error!; diagnostic redaction; verify 8/8; volva 6bfc37b |
